  ...
  return (
    <>
      <div className="relative w-full h-[80vh]">
        <img src={shopBgPic} alt="Shop Background" className="w-full h-full object-cover" />
            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <a
                    href="#"
                    className="ms-1 text-lg font-extrabold text-gray-700 md:ms-2 dark:text-gray-400"
                  >
                    Cart
                  </a>
                </div>
      ...
      <div className="flex flex-col lg:flex-row mt-16 px-4 lg:px-10">
        ...
        <div className="w-full lg:w-1/4 bg-[#fbf1e7] p-6 rounded-md shadow-md ml-0 lg:ml-6 mt-6 lg:mt-0 h-64 overflow-y-auto">
          <h2 className="text-3xl font-bold mb-6 text-center">Cart Totals</h2>
          <div className="flex justify-between mb-4">
            <span>Subtotal</span>
            <span className="text-gray-700 text-right">${subTotal.toFixed(2)}</span>
          </div>
          <div className="flex justify-between mb-6">
            <span>Total</span>
            <span className="font-bold text-xl text-[#c28c2b] text-right">${subTotal.toFixed(2)}</span>
          </div>
          <button 
